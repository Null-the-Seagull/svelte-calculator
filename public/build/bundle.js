    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 11, 1, 164);
    			add_location(hr, file, 12, 1, 183);
    			attr_dev(input, "id", "inp_display");
    			attr_dev(input, "type", "text");
    			input.value = /*result_display*/ ctx[0];
    			input.readOnly = true;
    			add_location(input, file, 13, 1, 190);
    			add_location(br, file, 13, 69, 258);
    			button0.value = "7";
    			attr_dev(button0, "class", "svelte-15qukjs");
    			add_location(button0, file, 17, 4, 295);
    			add_location(td0, file, 16, 3, 285);
    			button1.value = "8";
    			attr_dev(button1, "class", "svelte-15qukjs");
    			add_location(button1, file, 20, 4, 372);
    			add_location(td1, file, 19, 3, 362);
    			button2.value = "9";
    			attr_dev(button2, "class", "svelte-15qukjs");
    			add_location(button2, file, 23, 4, 448);
    			add_location(td2, file, 22, 3, 438);
    			add_location(tr0, file, 15, 2, 276);
    			button3.value = "4";
    			attr_dev(button3, "class", "svelte-15qukjs");
    			add_location(button3, file, 28, 4, 541);
    			add_location(td3, file, 27, 3, 531);
    			button4.value = "5";
    			attr_dev(button4, "class", "svelte-15qukjs");
    			add_location(button4, file, 31, 4, 618);
    			add_location(td4, file, 30, 3, 608);
    			button5.value = "6";
    			attr_dev(button5, "class", "svelte-15qukjs");
    			add_location(button5, file, 34, 4, 697);
    			add_location(td5, file, 33, 3, 687);
    			add_location(tr1, file, 26, 2, 522);
    			button6.value = "1";
    			attr_dev(button6, "class", "svelte-15qukjs");
    			add_location(button6, file, 39, 4, 793);
    			add_location(td6, file, 38, 3, 783);
    			button7.value = "2";
    			attr_dev(button7, "class", "svelte-15qukjs");
    			add_location(button7, file, 42, 4, 870);
    			add_location(td7, file, 41, 3, 860);
    			button8.value = "3";
    			attr_dev(button8, "class", "svelte-15qukjs");
    			add_location(button8, file, 45, 4, 946);
    			add_location(td8, file, 44, 3, 936);
    			add_location(tr2, file, 37, 2, 774);
    			add_location(table, file, 14, 1, 265);
    			attr_dev(main, "class", "svelte-15qukjs");
    			add_location(main, file, 10, 0, 155);
    		},
